const products = [
    ...
    },
    {
        ...
        description:
            "дарная установка Stagestar – это отличное качество и цена, что делает ее идеальным выбором для начинающих музыкантов, которые хотят получить хороший инструмент за небольшие деньги.",
        price: 55000
    },
    {
